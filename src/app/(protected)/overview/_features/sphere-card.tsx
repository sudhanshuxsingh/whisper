...
const SphereCard = ({
  ...
  return (
    <Link
      ...
      className="group/dashboard-card rounded-xl bg-secondary/80 p-1 pb-0 dark:bg-secondary/40"
    >
      <div className="relative flex h-5/6 flex-1 flex-col justify-between overflow-hidden rounded-lg border border-primary/10 bg-background/70 px-4 py-3 pt-6">
