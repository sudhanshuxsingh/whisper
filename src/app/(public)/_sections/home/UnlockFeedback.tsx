...
const UnlockFeedback = () => {
  return (
    <Container className="z-10">
      <h3 className="text-gradient my-6 text-center text-4xl md:text-6xl">
        Unlock Powerful
      ...
      <div className="mt-14 grid grid-cols-3 gap-6 [--home-page-gradient-color:120,_119,_198,_0.1]">
        ...
        <div className="relative flex h-[28rem] flex-col items-center justify-end overflow-hidden rounded-xl border bg-secondary/10 bg-gradient-to-tr from-transparent p-8 text-center dark:to-[rgba(var(--home-page-gradient-color))]">
          <div className="mask-radial-faded absolute flex h-[130%] w-[130%] items-center justify-center">
        ...
        <div className="relative flex h-[28rem] flex-col items-center justify-end overflow-hidden rounded-xl border bg-secondary/10 bg-gradient-to-tr from-transparent p-8 text-center dark:to-[rgba(var(--home-page-gradient-color))]">
          <div className="mask-radial-faded absolute -bottom-[1%] flex h-[190%] w-[190%] items-end justify-center">
        ...
        <div className="relative col-span-2 flex h-[28rem] flex-col items-center overflow-hidden rounded-xl border bg-secondary/10 bg-gradient-to-tr from-transparent p-8 after:absolute dark:to-[rgba(var(--home-page-gradient-color))]">
          <div className="mask-linear-faded absolute top-[38%] -z-[2] h-full w-9/12 from-transparent to-primary">
            <APICodeBlock />
          </div>
